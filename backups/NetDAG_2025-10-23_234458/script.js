...
/* Google Translate (hidden UI, single instance) */
(function () {
  // Create one hidden container for Google Translate
  ...
  // Define init callback (called when Google loads)
  window.googleTranslateElementInit = function () {
    new google.translate.TranslateElement(
      {
        pageLanguage: 'en',
        includedLanguages: 'en,de,fr', // add more later
        autoDisplay: false,
        layout: google.translate.TranslateElement.InlineLayout.SIMPLE
      },
      'google_translate_element'
    );
    // sync Google’s selector to our saved language
...
/* Page-to-page nav */
(function(){
// 👉 Skip auto nav on any /blog/ page (we use manual buttons there)
