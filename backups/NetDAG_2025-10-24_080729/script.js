...
const I18N = {
  en: {
    ...
    pages: {
      "index.html": {
        heroTitle:
          "NetDAG is the first crypto built with a <strong>mathematical shock absorber</strong>.",
        heroSubtitle:
          "Our technology protects your investment from volatility, rewards real-world use, and builds a Web3 economy you can trust."
      },
      "bonding-curve.html": {
      ...
      "guardian.html": {
        ...
        heroSubtitle:
          "Our AI layer predicts liquidity needs, detects anomalies, and proposes optimizations."
      },
      "provenance.html": {
        heroTitle: "Trust Written in Code: NetDAG Provenance",
        heroSubtitle:
          "Authenticity as on-chain proof — scannable by anyone, instantly."
      },
      "dvpn.html": {
        heroTitle: "Your Privacy, Powered by the People",
        heroSubtitle:
          "A decentralized VPN for secure, censorship-resistant internet access."
      }
    }
  },
  ...
  de: {
    ...
    pages: {
      "index.html": {
        heroTitle:
          "NetDAG ist die erste Kryptowährung mit einem <strong>mathematischen Stoßdämpfer</strong>.",
        heroSubtitle:
          "Unsere Technologie schützt vor Volatilität, belohnt echte Nutzung und baut eine vertrauenswürdige Web3-Ökonomie."
      },
      "bonding-curve.html": {
        heroTitle: "Stabilität durch Design: Die NetDAG Bonding Curve",
        heroSubtitle:
          "Ein mathematischer Motor, der Hype-Schwankungen in vorhersehbare Preisbewegungen verwandelt."
      },
      "guardian.html": {
        heroTitle: "Intelligenz im Kern: Der NetDAG Guardian",
        heroSubtitle:
          "Unsere KI-Schicht prognostiziert Liquiditätsbedarf, erkennt Anomalien und schlägt Optimierungen vor."
      },
      "provenance.html": {
        heroTitle: "Vertrauen im Code: NetDAG Herkunftsnachweis",
        heroSubtitle:
          "Echtheit als On-Chain-Beweis — für alle sofort prüfbar."
      },
      "dvpn.html": {
        heroTitle: "Deine Privatsphäre, von Menschen betrieben",
        heroSubtitle:
          "Ein dezentraler VPN für sichere, zensurresistente Verbindungen."
      }
    }
  },
  ...
  fr: {
    ...
    pages: {
      "index.html": {
        heroTitle:
          "NetDAG est la première crypto dotée d’un <strong>amortisseur mathématique</strong>.",
        heroSubtitle:
          "Notre technologie protège contre la volatilité, récompense l’usage réel et construit une économie Web3 fiable."
      },
      "bonding-curve.html": {
        heroTitle: "Stabilité par conception : la Courbe de liaison NetDAG",
        heroSubtitle:
          "Un moteur mathématique qui transforme la volatilité en trajectoires de prix prévisibles."
      },
      "guardian.html": {
        heroTitle: "L’intelligence au cœur : le NetDAG Guardian",
        heroSubtitle:
          "Notre couche IA anticipe la liquidité, détecte les anomalies et propose des optimisations."
      },
      "provenance.html": {
        heroTitle:
          "La confiance écrite dans le code : Traçabilité NetDAG",
        heroSubtitle:
          "Authenticité on-chain — vérifiable par tous, instantanément."
      },
      "dvpn.html": {
        heroTitle: "Votre vie privée, portée par le peuple",
        heroSubtitle:
          "Un VPN décentralisé pour un accès sécurisé et résistant à la censure."
      }
    }
  }
};
...
function translateNavbarLinks() {
  ...
  document.querySelectorAll(".nav-links a[href]").forEach((a) => {
    ...
    a.textContent =
      dict[ns] && dict[ns][prop] ? dict[ns][prop] : I18N.en[ns][prop];
  });
}
...
function translateAutoHero() {
  ...
  const p =
    location.pathname.replace(/\\/g, "/").split("/").pop() || "index.html";
...
})();  // ← closes the Page Navigation IIFE
...
document.addEventListener('DOMContentLoaded', () => {
  try { runTranslations(); } catch {}
});
document.addEventListener('DOMContentLoaded', () => {
  try { setGoogleLang(getLang()); } catch {}
});
window.addEventListener('pageshow', () => {
  setTimeout(() => { try { setGoogleLang(getLang()); } catch {} }, 300);
});
